...
gameHtml = TL.concat
    ...
    , "    "
    , "    <div class='actions'>"
    , "      <button id='btn-draw' class='btn' onclick='drawTile()'>🎴 Robar</button>"
    , "      <button id='btn-pass' class='btn' onclick='passTurn()'>⏭️ Pasar</button>"
...
jsScript = TL.unlines
    ...
    , "      boardDiv.appendChild(createDominoElement(tile, true));"
    , "    });"
    , "  }"
    , "  "
