...
indexHtml = TL.concat
    ...
    , "          <button onclick=\"selectVsMode('2vs2')\" id='btn-2vs2' class='btn-selector disabled' disabled>👥👥 2 vs 2 🔒</button>"
    , "        </div>"
    , "      </div>"
    , ""
    , "      <!-- Dificultad -->"
    ...
    , "          <button onclick=\"selectDifficulty('hard')\" id='btn-hard' class='btn-selector btn-diff-hard disabled' disabled>😈 Difícil 🔒</button>"
    , "        </div>"
    , "      </div>"
    , ""
